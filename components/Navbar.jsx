        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-teal-500 to-blue-600 text-white px-6 py-2 rounded-md font-medium hover:opacity-90 transition-opacity"
            >
              Get Started Free
            </button>
          </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pt-4 space-y-3">
              <button
                ...
                className="w-full text-gray-300 hover:text-white px-4 py-2 rounded-md text-base font-medium"
              >
                Sign In
              </button>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-teal-500 to-blue-600 text-white px-4 py-2 rounded-md font-medium"
              >
                Get Started Free
              </button>
            </div>
